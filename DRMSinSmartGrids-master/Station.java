...
public class Station extends UnicastRemoteObject implements StationInterface, Runnable{

    static List<String> stationNames = {"STN_101", "STN_102", "STN_103"};
